...
export default function Info() {
    return (
        <div className="pageDiv">
            ...
            <p className="pageSubtitle">Unharmed is a project still in its infancy.</p>
            <p>It means it's still full of potential to become many different things. When I think about its future, I envision:</p>
                <ul>
                    <li className="aboutus--li">website easy and ejoyable to browse on a smartphone,</li>
                    <li className="aboutus--li">website without trackers,</li>
                    <li className="aboutus--li">website full of harm reduction tools and calculators,</li>
                    <li className="aboutus--li">website with tools helping users to quit substance abuse,</li>
                    <li className="aboutus--li">website where users can share their psychedelic experiences trully anonymously,</li>
                    <li className="aboutus--li">bridge between vendors and users, creating feeling of individual approach to clients,</li>
                    <li className="aboutus--li">bridge between creators and psychedelic community,</li>
                    <li className="aboutus--li">place where forgotten blogs and forums are getting rediscovered and brought back to life.</li>
                </ul>
